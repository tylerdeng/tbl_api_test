  ...
  included do
    rails_admin do
      list do
        ...
        def list_config(field_value, label_value, column_width_value, formatted_value_1, formatted_value_2)
        ...
        def list_config_bindings(field_value, label_value, column_width_value, formatted_value)
          field field_value do
            label label_value if label_value.present?
            column_width column_width_value if column_width_value.present?
            formatted_value { bindings[:object].addresses[0][formatted_value] if bindings[:object].addresses.present? } if formatted_value.present?
          end
        end
        ...
        list_config_bindings(:city, 'City', 100, :city)
        list_config_bindings(:state, 'State', 100, :state)
